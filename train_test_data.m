...
%     indexToTesting=(idx>size1);
    ...
    Xtraining_data=xtrain; % input to SFA
    Xtesting_data=xtest; % input to SFA

    training_QualityVar=ytrain;
    testing_Qualityvar=ytest;
